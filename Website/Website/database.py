...
#register_output = register('test21', 'test21', 'test@gmail.com', 'Electrical Engineering', 'Junior', 'password','testing1122234')
#print(register_output)

#add class to cart
add_class_to_shoppingcart(section_id=2, student_id=1)
